...
return [
    ...
    | telles que les règles de taille. N'hésitez pas à modifier chacun de ces messages ici.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques et symboles monocodés.',
    ...
    */
    ...
    'attributes' => [
        ...
        'general_conditions' => 'des conditions générales',
        'avatar' => 'de la photo de profil',
        'starting_at' => 'de la date de début',
        'ending_at' => 'de la date de fin',
        'deleted_at' => 'de la date de suppression',
        // invoices
        'file' => 'fichier',
        ...
        'type' => 'type',
        'category' => 'catégorie',
        'issuer_name' => 'nom du fournisseur',
