...
class Breadcrumb extends Component
{
     ...
     */
    protected $homeIcon = '<svg class="mr-2 text-gray-600 hover:text-indigo-600" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    protected function buildBreadcrumbSegments(): void
    {
        ...
        if ($currentRoute === 'dashboard') {
            $this->segments[] = [
                'name' => 'dashboard',
                'label' => 'Tableau de bord', // Si vide => seulement l'icône
                'url' => route('dashboard'),
                'icon' => $this->homeIcon,
                'current' => true,
            ];
