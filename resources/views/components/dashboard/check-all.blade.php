<div x-data="checkAll">
    <label for="checkboxMultiple" class="relative flex items-center cursor-pointer p-4 w-fit">
        <input id="checkboxMultiple" x-ref="checkbox" @change="handleCheck" type="checkbox" class="peer h-4 w-4 cursor-pointer transition-all appearance-none rounded border border-slate-300 checked:bg-blue-700 indeterminate:bg-blue-700 checked:border-blue-700 indeterminate:border-blue-700" />
