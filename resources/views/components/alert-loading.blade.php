...
<div wire:loading.flex wire:target="{{ $target }}"
     ...
     style="display: none;"
>
    <div class="animate-rotate absolute inset-0 h-full w-full rounded-full bg-[conic-gradient(from_0deg_at_50%_50%,#5096FF,#5096FF,transparent_120deg,transparent_360deg)] z-10"></div>
