...
<ul class="font-medium custom-mt-auto">
    ...
    <li>
        <a href="{{ route('settings') }}" class="{{ $linkClass }}">
            <x-heroicon-o-cog class="{{ $svgClass }}"/>
            <span x-show="expanded" class="ml-3">Paramètres</span>
        </a>
    </li>
    <li>
        <a href="{{ route('help-center') }}" class="{{ $linkClass }}">
            <x-heroicon-o-question-mark-circle class="{{ $svgClass }}"/>
