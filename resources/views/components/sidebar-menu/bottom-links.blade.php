...
<ul class="font-medium custom-mt-auto">
    <li>
        <a href="#" class="flex items-center p-2 py-1.5 text-gray-700 rounded-lg dark:text-gray-400 group">
            <x-heroicon-o-arrow-path class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-50"/>
            @if(!$sidebarWide)
    ...
    <li>
        <a href="#" class="flex items-center p-2 py-1.5 text-gray-700 rounded-lg dark:text-gray-400 group">
            <x-heroicon-o-cog class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-50"/>
            @if(!$sidebarWide)
    ...
    <li>
        <a href="#" class="flex items-center p-2 py-1.5 text-gray-700 rounded-lg dark:text-gray-400 group">
            <x-heroicon-o-question-mark-circle class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-50"/>
            @if(!$sidebarWide)
