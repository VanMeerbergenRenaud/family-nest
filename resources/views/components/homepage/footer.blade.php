...
<footer class="bg-slate-100 text-gray-700" aria-labelledby="footer-heading">
    ...
    {{-- PARTIE SUPÉRIEURE : Logo et liens principaux --}}
                                ...
                                <li>
                                    <a href="{{ $link['is_disabled'] ?? false ? '#' : $link['url'] }}"
                                       ...
                                       @endif
                                        ...
                                        @class([
                                            'group inline-flex flex-wrap items-center gap-2 text-gray-600 transition-all duration-300',
                                            'hover:text-gray-900' => !($link['is_disabled'] ?? false),
                                            'cursor-not-allowed opacity-60' => $link['is_disabled'] ?? false,
                                        ])
                                    >
