...
@section('title', __('Erreur 402'))
@section('icon')
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="#334054">
...
@endsection
@section('code', '402')
@section('description', __('Paiement requis'))
@section('message', __('FamilyNest ne peut pas vous aider sans votre soutien financier.'))
