...
@endsection
@section('code', '429')
@section('description', __('Trop de requêtes'))
@section('message', __('FamilyNest a reçu trop de requêtes de votre part, veuillez patienter un moment avant de réessayer.'))
