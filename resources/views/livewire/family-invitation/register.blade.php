<div>
    <div class="max-w-md mx-auto flex-center h-screen">
        <div class="p-6 h-fit bg-white dark:bg-gray-800 rounded-2xl overflow-hidden">
            <h2 class="pl-2 text-xl-semibold text-gray-900 dark:text-gray-100 mb-1">{{ __('Rejoindre la famille') }}</h2>
            <p class="pl-2 text-sm-regular text-gray-500 dark:text-gray-400 mb-4">{{ __('Créez votre compte pour rejoindre la famille') }}</p>
