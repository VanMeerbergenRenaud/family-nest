    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800">
            ...
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    <div class="flex-shrink-0 p-3 h-fit bg-indigo-50 dark:bg-indigo-900/30 rounded-lg border border-indigo-100 dark:border-indigo-800/40 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-800/50 transition-colors duration-300">
                        <x-svg.user class="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
                    </div>
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-indigo-700 dark:group-hover:text-indigo-400"
                        >
                            Profil
                        </h3>
        ...
        >
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-sky-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800">
                    <x-svg.arrow-up-hover />
                </div>
            </div>
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    ...
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-sky-700 dark:group-hover:text-sky-400"
                        >
                            Stockage
                        </h3>
                        <p class="mt-1.5 text-sm text-gray-600 dark:text-gray-400">
        ...
        >
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-orange-50 dark:bg-orange-900/30 border border-orange-100 dark:border-orange-800">
                    <x-svg.arrow-up-hover />
                </div>
            </div>
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    <div class="flex-shrink-0 p-3 h-fit bg-orange-50 dark:bg-orange-900/30 rounded-lg border border-orange-100 dark:border-orange-800/40 group-hover:bg-orange-100 dark:group-hover:bg-orange-800/50 transition-colors duration-300">
                        <x-svg.bell class="w-6 h-6 text-orange-600 dark:text-orange-400" />
                    </div>
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-orange-700 dark:group-hover:text-orange-400"
                        >
                            Notifications
                        </h3>
                        <p class="mt-1.5 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div class="mt-3 flex items-center gap-1.5">
                            ...
                            <span class="text-xs text-orange-600 dark:text-orange-400">Notifications non lues</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="{{ route('settings.appearance') }}"
           ...
           wire:navigate>
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-purple-50 dark:bg-purple-900/30 border border-purple-100 dark:border-purple-800">
                    <x-svg.arrow-up-hover />
                </div>
            </div>
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    ...
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-purple-700 dark:group-hover:text-purple-400"
                        >
                            Apparence
                        </h3>
                        <p class="mt-1.5 text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href="{{ route('settings.billing') }}"
           ...
           wire:navigate>
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-teal-50 dark:bg-teal-900/30 border border-teal-100 dark:border-teal-800">
                    <x-svg.arrow-up-hover />
                </div>
            </div>
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    ...
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-teal-700 dark:group-hover:text-teal-400"
                        >
                            Plan de paiement
                        </h3>
                        <p class="mt-1.5 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div class="mt-3 inline-block px-2 py-1 bg-teal-50 dark:bg-teal-900/30 rounded text-xs-medium text-teal-700 dark:text-teal-400">
        ...
        <a href="{{ route('settings.danger') }}"
           ...
           wire:navigate>
            <div class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out transform translate-x-2 -translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0">
                <div class="flex-center h-8 w-8 rounded-full bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-800">
                    <x-svg.arrow-up-hover />
                </div>
            </div>
            <div class="px-5 py-4 group-hover:bg-gray-50/50 dark:group-hover:bg-gray-800/60 transition-colors duration-300">
                <div class="flex gap-4 items-start">
                    ...
                    <div class="flex-1">
                        <h3 role="heading" aria-level="3"
                            class="text-md-semibold text-gray-800 dark:text-white transition-colors duration-300 group-hover:text-red-700 dark:group-hover:text-red-400"
                        >
                            Zone de danger
                        </h3>
                        <p class="mt-1.5 text-sm text-gray-600 dark:text-gray-400">
