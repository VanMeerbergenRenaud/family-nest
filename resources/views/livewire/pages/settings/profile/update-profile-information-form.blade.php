...
<section class="p-6">
    ...
    <form wire:submit="updateProfileInformation">
        ...
        <div class="mb-8 flex flex-col gap-4">
            <x-form.field label="Nom" name="name" model="name" placeholder="Renseigner votre nom"/>
            <x-form.field label="Adresse email" name="email" model="email" type="email" placeholder="Renseignez votre adresse email"/>
        </div>
