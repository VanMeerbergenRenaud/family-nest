<x-guest-layout title="Accueil">
    ...
    @php
        ...
        $testimonials = [
            ['quote' => 'T\'es le meilleur ! Tu designs super bien et tu passes beaucoup de temps sur ton appli. Prends un peu plus de temps pour moi ! Sinon, j\'adore l\'utiliser. Tu pourrais juste améliorer certaines couleurs, je t\'expliquerai. ❤️', 'name' => 'Amélie R.', 'title' => 'Ma copine', 'image' => asset('img/homepage/testimonials/amelie.jpeg')],
