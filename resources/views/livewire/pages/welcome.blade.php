<x-guest-layout>
    ...
    @php
        ...
        $features = [
            ['title' => '1. Créer votre compte', 'description' => 'En seulement quelques clics, enregistrez-vous et accédez à l\'application. Vérifier vos mails et puis le tour est joué. Il ne vous plus qu\'a créer votre nouvelle famille.', 'image' => asset('img/homepage/features/step_1.png')],
            ...
            ['title' => '3. Fixer vous un objectif', 'description' => 'Grâce à la fonctionnalité d\'objectifs, vous pouvez définir des budgets mensuels ou annuels pour mieux gérer vos finances familiales.', 'image' => asset('img/homepage/features/step_3.png')],
        ];
        ...
        $testimonials = [
            ['quote' => 'T\'es le meilleur ! Tu design super bien et tu passes beaucoup de temps sur ton appli. Prends un peu plus de temps pour moi ! Sinon, j\'adore l\'utiliser. Tu pourrais juste améliorer certaines couleurs, je t\'expliquerai. ❤️', 'name' => 'Amélie R.', 'title' => 'Ma copine', 'image' => asset('img/homepage/testimonials/amélie.jpeg')],
            ['quote' => 'Olala, je fais vraiment n\'importe quoi, j\'ai des erreurs partout ! Il faut que tu m\'aides et que tu me montres comment faire, car je suis perdue. Par contre, j\'adorerais pouvoir l\'utiliser, car je ne risque pas de me montrer avec toutes ces restrictions. 😅', 'name' => 'Monique D.', 'title' => 'Ma mamy', 'image' => asset('img/homepage/testimonials/monique.png')],
            ...
            ['quote' => 'Je suis certainement l\'utilisatrice la plus active sur l\'application à ce jour, j\'ai presque tout testé et j\'adore vraiment toutes les fonctionnalités présentées. Merci à toi d\'avoir développer cette application, elle m\'est d\'une aide précieuse.', 'name' => 'France M.', 'title' => 'Ma maman', 'image' => asset('img/homepage/testimonials/france.jpg')],
            ['quote' => 'Salut Renaud, je viens de tester ça. Bravo à toi, c\'est très propre ! Très agréable à utiliser. J\'ai juste eu deux petits problèmes "techniques" au moment de créer la facture. L\'aperçu de ma facture PDF n\'a pas fonctionné quand je l\'ai importée et je n\'arrivais pas a répartir mon montant 🫤.', 'name' => 'Florian R.', 'title' => 'Indépendant & menuisier', 'image' => asset('img/homepage/testimonials/florian.png')],
            ['quote' => 'À prendre ou à laisser mais perso je mettrai les boutons en disabled avec le style disabled si tu n’as pas de fonctionnalités derrière. Sinon les gens au PFE vont s’énerver et croire que ça marche pas. Sinon c’est cleeeeeaaaaaaan j\'adore !', 'name' => 'Julien M.', 'title' => 'Développeur incroyable', 'image' => asset('img/homepage/testimonials/justin.png')],
            ...
            ['quote' => 'C\'est exactement ce que je cherchais. C\'est direct, efficace et le design est très agréable. Je l\'acheterai dès que ca sortira c\'est certain !', 'name' => 'Anissa F.', 'title' => 'Voisine architecte', 'image' => asset('img/homepage/testimonials/anissa.png')],
        ];

        $faqs = [
            ['question' => 'Qui se cache derrière ce projet ?', 'answer' => 'FamilyNest est un projet développé avec passion par le développeur Renaud Van Meerbergen, pour son travail de fin d\'études, avec l\'ambition d\'en faire un outil réellement utile pour les familles. Chaque retour et chaque suggestion compte énormément pour l\'améliorer !'],
