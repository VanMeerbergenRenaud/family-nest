                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div class="flex space-x-1">
                            @if(!empty($invoice->tags))
                                @foreach(is_array($invoice->tags) ? $invoice->tags : json_decode($invoice->tags, true) as $tag)
                            ...
                            <div>
                                ...
                                <div class="mt-6 mb-2 flex flex-col gap-3">
                                    ...
                                    <input x-model="confirmation" placeholder="CONFIRMER" type="text" id="confirmation"
                                           class="p-2 px-4 text-sm border border-gray-300 rounded-md w-[87.5%]" autofocus>
                                </div>
                            </div>
                        </div>
                    </div>
